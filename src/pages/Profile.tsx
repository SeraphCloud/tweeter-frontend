	...
	return (
		<div className="min-h-screen bg-black">
			...
			<div className="max-w-6xl mx-auto px-4 flex gap-8 mt-4">
				{/* Coluna vazia esquerda — balanceia o layout */}
				<div className="w-72 shrink-0 hidden lg:block" />

				{/* Coluna central — perfil */}
				<div className="flex-1 min-w-0 space-y-8 pb-8">
					{/* Cabeçalho do perfil */}
					<div className="flex items-center gap-4 border-b border-zinc-800 pb-6 pt-2">
					...
					<div className="border border-zinc-800 rounded-2xl p-6">
						...
						<form onSubmit={handleSubmit} className="space-y-4">
							...
							{success && (
								<p className="text-green-500 text-sm">Perfil atualizado!</p>
							)}
							<button
								type="submit"
								disabled={loading}
